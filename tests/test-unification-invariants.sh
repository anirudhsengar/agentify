...
[ -d packaged/skills/plan ] && fail "skill 'plan' must not exist — the build-spec command is /spec (ADR-0010)"
...
while IFS= read -r adr; do
  [ -f "docs/adr/$adr" ] || fail "referenced ADR is missing: docs/adr/$adr"
           ...
           packaged/skills scaffold docs README.md 2>/dev/null \
