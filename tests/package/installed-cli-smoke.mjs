...
try {
  ...
  assert.match(engageHelp.stdout, /agentify engage <init\|status\|validate\|report\|promotion\|metrics\|shadow>/);
  assert.match(engageHelp.stdout, /metrics <status\|record-baseline\|record-review\|record-adoption\|report>/);
