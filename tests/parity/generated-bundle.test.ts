...
test("brownfield and greenfield renderers preserve deterministic path inventories", () => {
...
test("apply is deterministic while preserving managed and user-owned files", () => {
...
test("required conflicts abort the complete bundle with zero writes", () => {
