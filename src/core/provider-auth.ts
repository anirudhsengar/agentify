...
export const AGENTIFY_PROVIDERS = [
  ...
  { label: "Baseten", value: "baseten", env: ["BASETEN_API_KEY"], runtimeKeyEnv: ["BASETEN_API_KEY"] },
  ...
  { label: "Qwen Token Plan", value: "qwen-token-plan", env: ["QWEN_TOKEN_PLAN_API_KEY"], runtimeKeyEnv: ["QWEN_TOKEN_PLAN_API_KEY"] },
  { label: "Qwen Token Plan (China)", value: "qwen-token-plan-cn", env: ["QWEN_TOKEN_PLAN_CN_API_KEY"], runtimeKeyEnv: ["QWEN_TOKEN_PLAN_CN_API_KEY"] },
  { label: "Radius", value: "radius", env: ["RADIUS_API_KEY"], runtimeKeyEnv: ["RADIUS_API_KEY"] },
