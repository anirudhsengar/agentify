...
function repairPrompt(
  ...
  return [
    ...
    "Resolve the earliest distinct behavior in that ordered cluster batch before leaf utilities unless stronger repository evidence proves another obligation blocks it.",
