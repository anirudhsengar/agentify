  ...
  return [
    ...
    markdownArtifact({
      ...
      body: [
        ...
        `Keep durable application knowledge here and link it from \`${context.stateDir}/conditional_docs.md\` when it should be loaded conditionally.`,
        "",
        "## Entry Template",
        "",
        ...
        `- When to load: trigger phrases or touched paths for \`${context.stateDir}/conditional_docs.md\`.`,
