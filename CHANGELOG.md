...
- After a source-backed precheck finding prunes a surplus assertion, send the changed body directly to complete review instead of repeating the same local precheck and consuming its review window.
