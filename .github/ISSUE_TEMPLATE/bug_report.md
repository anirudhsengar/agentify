...
lines of the referenced Agentify log under the user configuration directory, and
any stack traces. -->
...
<!-- Attach or inline the contents of:
  - the reported Agentify log (last ~200 lines)
  - .agentify/runtime/audit/codebase_map.json when the failure is in audit closure
