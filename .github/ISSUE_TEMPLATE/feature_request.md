...
- [ ] Persistent memory or specialists (`src/core/memory/`, `src/core/specialists/`)
- [ ] Issue lifecycle (`src/core/task-lifecycle/`)
- [ ] Accepted-merge learning (`src/core/learning/`)
- [ ] Scaffold shipped to target repos (`scaffold/`)
- [ ] Focused installed artifacts (`AGENTS.md`, policy, runtimes, workflows)
- [ ] New runtime dependency (requires maintainer approval)
- [ ] Breaking change (semver major)

## Test plan

<!-- How would you verify this end-to-end? Agentify's verification suite is
