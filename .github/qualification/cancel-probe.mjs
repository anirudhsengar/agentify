...
const candidate='529c937d46e7ae45876a22f52bd4a820ccd0deab';
...
const explorer=createSpawnExplorerTool({agentDir,stateDir:'.agentify/runtime/audit',explorerModel:model,resourceBudget:budget,
 createSession:async(options)=>{
  ...
  created.session.subscribe(event=>{
   ...
   if(triggeredAt===null&&(event.type==='message_update'||event.type==='message_end'&&event.message?.role==='assistant'&&event.message?.stopReason!=='error')){
