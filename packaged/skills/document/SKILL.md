...
`.pi/conditional_docs.md`. This is the **learn** step of the feedback loop — it is how the
...
4. **Update `.pi/conditional_docs.md`:** append an entry for the new doc with 2–4
