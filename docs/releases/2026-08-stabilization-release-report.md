...
The approved gate now separates high-quality specialist installation from operational execution readiness. A semantically complete `analysis-ready` team may count as an installation, while missing reproducible repository-owned validation keeps issue intake, publication, autonomous mutation and learning disabled. External harness locks never clear those execution blockers. Exact `60936a8adc8be07a7e232b897b49f726ac4d8cb6` passed the local Node 22 release suite and Node 22/24 CI, including packed missing-test and lockless analysis-ready installation cases. Its package hash is `5a0a281084f12bbbc5e70b58d1163d25a48f5b6903086bcaccb71855acf1a31d` (51 entries). CodeQL failed on a managed-file check/read race and Windows batch shell input; corrections are in progress. No new live matrix, manual-quality pass, or unchanged-SHA round is credited.
