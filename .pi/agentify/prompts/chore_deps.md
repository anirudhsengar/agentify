---
description: Write an agentify build spec for chore_deps work in this repository.
argument-hint: "<one-sentence chore_deps task>"
---
<!-- agentify:managed -->
...
Write a build spec for $ARGUMENTS to `specs/chore_deps-<slug>.md`.
