---
description: Write an agentify build spec for test work in this repository.
argument-hint: "<one-sentence test task>"
---
<!-- agentify:managed -->
...
Write a build spec for $ARGUMENTS to `specs/test-<slug>.md`.
