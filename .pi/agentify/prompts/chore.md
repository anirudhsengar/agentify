---
description: Write an agentify build spec for chore work in this repository.
argument-hint: "<one-sentence chore task>"
---
<!-- agentify:managed -->
...
Write a build spec for $ARGUMENTS to `specs/chore-<slug>.md`.
