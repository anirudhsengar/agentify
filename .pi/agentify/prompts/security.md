---
description: Write an agentify build spec for security work in this repository.
argument-hint: "<one-sentence security task>"
---
<!-- agentify:managed -->
...
Write a build spec for $ARGUMENTS to `specs/security-<slug>.md`.
