---
description: Write an agentify build spec for refactor work in this repository.
argument-hint: "<one-sentence refactor task>"
---
<!-- agentify:managed -->
...
Write a build spec for $ARGUMENTS to `specs/refactor-<slug>.md`.
