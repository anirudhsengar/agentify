---
description: Write an agentify build spec for docs work in this repository.
argument-hint: "<one-sentence docs task>"
---
<!-- agentify:managed -->
...
Write a build spec for $ARGUMENTS to `specs/docs-<slug>.md`.
